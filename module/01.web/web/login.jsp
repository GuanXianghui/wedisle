...
<div class="wrap">
    <div class="signinbox">
        <h1>用户登录</h1>
        <form action="<%=baseUrl%>loginWedisle" method="post">
            <ul>
                <li>
                    <input type="text" placeholder="请输入邮箱" name="userName" value="<%=StringUtils.trimToEmpty((String)request.getAttribute("userName"))%>"/>
                    <div class="msgtip msgwarn" id="msg_id1" style="diaplay: none;"></div>
                </li>
                <li>
                    <input type="password" placeholder="请输入密码" name="password" />
                    <div class="msgtip msgwarn" id="msg_id2" style="diaplay: none;"></div>
                </li>
                <li>
                    <button>登&nbsp;&nbsp;&nbsp;录</button>
                </li>
