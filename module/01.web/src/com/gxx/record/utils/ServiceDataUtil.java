 ...
 * Author:       陈祺
 *
 * History:      2008-10-30 created by 陈祺
 */
...
public class ServiceDataUtil
{
     ...
     * 将直销dateTime转换成date
     *
     * @param dateTime 直销时间yyyyMMddHHmmss
     * @return Date
     */
     ...
     * 将直销日期返回成支付渠道请求字符串
     *
     * @param dateTime 直销dateTime请求字符串
     * @return 支付渠道请求日期字符串
     */
     ...
     * 将直销日期返回成支付渠道请求字符串
     *
     * @param date 直销date请求字符串
     * @param time 直销time请求字符串
     * @return 支付渠道请求日期字符串
     */
